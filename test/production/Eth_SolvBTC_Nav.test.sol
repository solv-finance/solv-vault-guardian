...
contract Base_SolvBTC_Nav is Test {
    ...
    address internal openFundMarket = 0x57bB6a8563a8e8478391C79F3F433C6BA077c567;
    bytes32 internal poolId_1 = 0x2dc130e46b5958208155546bd4049d5b3319798063a8c4180b4b2b82f3ebdc3d;
    bytes32 internal poolId_2 = 0x716db7dc196abe78d5349c7166896f674ab978af26ada3e5b3ea74c5a1b48307;
    bytes32 internal poolId_3 = 0xdc0937dd33c4af08a08724da23bc45b33b43fbb23f365e7b50a536ce45f447ef;
    bytes32 internal poolId_4 = 0x23299b545056e9846725f89513e5d7f65a5034ab36515287ff8a27e860b1be75;
    bytes32 internal fakePoolId = 0x23299b545056e9846725f89513e5d7f65a5034ab36515287ff8a27e860b1be76;
    ...
    function test_SetSubscribeNavAfterSettingGuard() public {
        _setGuard();
        vm.startPrank(safeOwner);
        _callExecTransaction(openFundMarket, 0, abi.encodeWithSignature("setSubscribeNav(bytes32,uint256,uint256)", poolId_1, block.timestamp, 1e8));
        _callExecTransaction(openFundMarket, 0, abi.encodeWithSignature("setSubscribeNav(bytes32,uint256,uint256)", poolId_2, block.timestamp, 1e8));
        _callExecTransaction(openFundMarket, 0, abi.encodeWithSignature("setSubscribeNav(bytes32,uint256,uint256)", poolId_3, block.timestamp, 1e8));
        _callExecTransaction(openFundMarket, 0, abi.encodeWithSignature("setSubscribeNav(bytes32,uint256,uint256)", poolId_4, block.timestamp, 1e18));
        _callExecTransactionShouldRevert(
            openFundMarket, 0.1 ether, abi.encodeWithSignature("setSubscribeNav(bytes32,uint256,uint256)", poolId_1, block.timestamp, 1e8), 
    ...
    function test_SetRedeemNavAfterSettingGuard() public {
        ...
        vm.startPrank(safeOwner);
        _callExecTransactionShouldRevert(
            openFundMarket, 0.1 ether, abi.encodeWithSignature("setRedeemNav(bytes32,uint256,uint256,uint256)", poolId_1, 111, 1e8, 1),
            "FoFNavManagerAuthorizationACL: transaction value not allowed"
        );
        _callExecTransactionShouldRevert(
        ...
        _callExecTransactionShouldRevert(
            openFundMarket, 0 ether, abi.encodeWithSignature("setRedeemNav(bytes32,uint256,uint256,uint256)", poolId_1, 111, 1e18, 1),
            "FoFNavManagerAuthorizationACL: invalid nav"
        );
        _callExecTransactionShouldRevert(
            openFundMarket, 0 ether, abi.encodeWithSignature("setRedeemNav(bytes32,uint256,uint256,uint256)", poolId_2, 111, 1e18, 1),
            "FoFNavManagerAuthorizationACL: invalid nav"
        );
        _callExecTransactionShouldRevert(
            openFundMarket, 0 ether, abi.encodeWithSignature("setRedeemNav(bytes32,uint256,uint256,uint256)", poolId_3, 111, 1e18, 1),
            "FoFNavManagerAuthorizationACL: invalid nav"
        );
        _callExecTransactionShouldRevert(
            openFundMarket, 0 ether, abi.encodeWithSignature("setRedeemNav(bytes32,uint256,uint256,uint256)", poolId_4, 111, 1e8, 1),
            "FoFNavManagerAuthorizationACL: invalid nav"
        );
        _callExecTransactionShouldRevert(
            openFundMarket, 0 ether, abi.encodeWithSignature("setRedeemNav(bytes32,uint256,uint256,uint256)", poolId_1, 111, 1e8, 10),
