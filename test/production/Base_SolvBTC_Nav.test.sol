...
contract Base_SolvBTC_Nav is Test {
    ...
    address internal openFundMarket = 0xf5a247157656678398B08d3eFa1673358C611A3f;
    bytes32 internal poolId_1 = 0x0d85d41382f6f2effeaa41a46855870ec8b1577c6c59cf16d72856a22988e3f5;
    bytes32 internal poolId_2 = 0x1706a4881586917b18c2274dfdbcdffe48ee22e18c99090dcee7dd38464526b4;
    bytes32 internal fakePoolId = 0x1706a4881586917b18c2274dfdbcdffe48ee22e18c99090dcee7dd38464526b5;
    ...
    function test_SetSubscribeNavAfterSettingGuard() public {
        ...
        _callExecTransaction(openFundMarket, 0, abi.encodeWithSignature("setSubscribeNav(bytes32,uint256,uint256)", poolId_2, block.timestamp, 1e18));
    ...
    function test_SetRedeemNavAfterSettingGuard() public {
        ...
        _callExecTransactionShouldRevert(
            openFundMarket, 0 ether, abi.encodeWithSignature("setRedeemNav(bytes32,uint256,uint256,uint256)", poolId_2, 111, 1e8, 1),
            "FoFNavManagerAuthorizationACL: invalid nav"
        );
        _callExecTransactionShouldRevert(
