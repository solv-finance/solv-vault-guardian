...
contract Rootstock_SolvBTC_Nav is Test {
    ...
    address internal openFundMarket = 0x6c8dA184B019E6C4Baa710113c0d9DE68A693B1f;
    bytes32 internal poolId = 0xf565aa1c019284a525d3157a65249ab8eae5792d52607b5469304b883afe1298;
    bytes32 internal fakePoolId = 0xf565aa1c019284a525d3157a65249ab8eae5792d52607b5469304b883afe1299;
    ...
    function test_SetSubscribeNavAfterSettingGuard() public {
        _setGuard();
        vm.startPrank(safeOwner);
        _callExecTransaction(openFundMarket, 0, abi.encodeWithSignature("setSubscribeNav(bytes32,uint256,uint256)", poolId, block.timestamp, 1e18));
        _callExecTransactionShouldRevert(
            openFundMarket, 0.1 ether, abi.encodeWithSignature("setSubscribeNav(bytes32,uint256,uint256)", poolId, block.timestamp, 1e18), 
            "FoFNavManagerAuthorizationACL: transaction value not allowed"
        );
        _callExecTransactionShouldRevert(
            openFundMarket, 0, abi.encodeWithSignature("setSubscribeNav(bytes32,uint256,uint256)", fakePoolId, block.timestamp, 1e18), 
    ...
    function test_SetRedeemNavAfterSettingGuard() public {
        ...
        vm.startPrank(safeOwner);
        _callExecTransactionShouldRevert(
            openFundMarket, 0.1 ether, abi.encodeWithSignature("setRedeemNav(bytes32,uint256,uint256,uint256)", poolId, 111, 1e18, 1),
            "FoFNavManagerAuthorizationACL: transaction value not allowed"
        );
        _callExecTransactionShouldRevert(
            openFundMarket, 0 ether, abi.encodeWithSignature("setRedeemNav(bytes32,uint256,uint256,uint256)", fakePoolId, 111, 1e18, 1),
            "FoFNavManagerAuthorizationACL: pool not authorized"
        );
        _callExecTransactionShouldRevert(
            openFundMarket, 0 ether, abi.encodeWithSignature("setRedeemNav(bytes32,uint256,uint256,uint256)", poolId, 111, 1.01e18, 1),
            "FoFNavManagerAuthorizationACL: invalid nav"
        );
        _callExecTransactionShouldRevert(
            openFundMarket, 0 ether, abi.encodeWithSignature("setRedeemNav(bytes32,uint256,uint256,uint256)", poolId, 111, 1e18, 10),
