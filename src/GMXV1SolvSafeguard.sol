...
contract GMXV1SolvSafeguard is SolvSafeguardRoot {
	...
	constructor(
		...
		__GMXV1SolvSafeguard_init(governor_, erc20_, cexRechargeAdress_, openEndFundMarket_, openEndFundShare_, openEndFundRedemption_);
	}
	
	function __GMXV1SolvSafeguard_init(address governor_, address erc20_, address cexRechargeAdress_, address openEndFundMarket_, 
		...
		address gmxV1OpenEndFundGuard = address(new GMXV1OpenEndFundGuard(safeAccount, governor_, openEndFundMarket_, openEndFundShare_, openEndFundRedemption_));
