...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  const fofNavManagerAuthorizationAddress = (await deployments.get("linea-solvBTC-FoFNavManagerAuthorization")).address;
  ...
  const guardianAddress = (await deployments.get("linea-solvBTC-NavManagerGuardianForSafe13")).address;
...
module.exports.tags = ["linea-solvBTC-NavManagerGuardianForSafe13-config"];
