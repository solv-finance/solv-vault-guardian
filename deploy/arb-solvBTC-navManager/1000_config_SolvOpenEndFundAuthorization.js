...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  const fofNavManagerAuthorizationAddress = (await deployments.get("arb-solvBTC-FoFNavManagerAuthorization")).address;
  ...
  const guardianAddress = (await deployments.get("arb-solvBTC-NavManagerGuardianForSafe13")).address;
...
module.exports.tags = ["arb-solvBTC-NavManagerGuardianForSafe13-config"];
