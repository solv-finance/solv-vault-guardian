...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  const fofNavManagerAuthorizationAddress = (await deployments.get("mantle-solvBTC-FoFNavManagerAuthorization")).address;
  ...
  const guardianAddress = (await deployments.get("mantle-solvBTC-NavManagerGuardianForSafe13")).address;
...
module.exports.tags = ["mantle-solvBTC-NavManagerGuardianForSafe13-config"];
