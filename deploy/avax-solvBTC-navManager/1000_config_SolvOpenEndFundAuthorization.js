...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  const fofNavManagerAuthorizationAddress = (await deployments.get("avax-solvBTC-FoFNavManagerAuthorization")).address;
  ...
  const guardianAddress = (await deployments.get("avax-solvBTC-NavManagerGuardianForSafe13")).address;
...
module.exports.tags = ["avax-solvBTC-NavManagerGuardianForSafe13-config"];
