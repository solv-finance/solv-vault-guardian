...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  const fofNavManagerAuthorizationAddress = (await deployments.get("soneium-solvBTC-FoFNavManagerAuthorization")).address;
  ...
  const guardianAddress = (await deployments.get("soneium-solvBTC-NavManagerGuardianForSafe13")).address;
...
module.exports.tags = ["soneium-solvBTC-NavManagerGuardianForSafe13-config"];
