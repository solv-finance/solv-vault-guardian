...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  const fofNavManagerAuthorizationAddress = (await deployments.get("bob-solvBTC-FoFNavManagerAuthorization")).address;
  ...
  const guardianAddress = (await deployments.get("bob-solvBTC-NavManagerGuardianForSafe13")).address;
...
module.exports.tags = ["bob-solvBTC-NavManagerGuardianForSafe13-config"];
