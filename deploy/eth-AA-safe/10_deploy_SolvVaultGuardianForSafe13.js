module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  const safeAccount = "0xEea6776566A5540F95180f7D4efc847362ec7bC9";
  const safeGovernor = deployer; //will transfer to safeGovernor after deployed
  const allowSetGuard = true;

  const deployName = "eth-AA-Safe-SolvVaultGuardianForSafe13";
...
module.exports.tags = ["eth-AA-Safe-SolvVaultGuardianForSafe13"];
